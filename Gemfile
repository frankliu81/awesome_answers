...
# we are telling Bundler in here that we need Rails with version exactly 4.2.6
gem 'rails', '4.2.6'
...
# this tell bunlder that we need coffee-rails gem with verion 4.1.x where x is
# 0 or more
